...
const restartbutton = document.querySelector(".btn-restart")//restart button
const highscoreElement =document.querySelector("#high-score")//high score
